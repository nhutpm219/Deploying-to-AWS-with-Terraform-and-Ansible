#Get EC2 Linux AMI ID using SSM Parameter endpoint in us-east-1
data "aws_ssm_parameter" "linuxAmi" {
  provider = aws.region-master
  name     = "/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2"
}

#Get EC2 Linux AMI ID using SSM Parameter endpoint in us-west-2
...
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook --extra-vars 'passed_in_hosts=tag_Name_${self.tags.Name}' ~/terraform-aws/ansible_templates/install_jenkins_master.yml
EOF
  }
}
